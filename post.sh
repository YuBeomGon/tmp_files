...
# docker run --gpus all -it --ipc=host --rm -v /opt/nvidia/deepstream/deepstream-6.1:/opt/nvidia/deepstream/deepstream-6.1 -v ~/downloads:/opt/nvidia/deepstream/deepstream-6.1/downloads beomgon/deepstream:inference bash
docker run --gpus all -it --ipc=host --rm -v ~/Downloads:/opt/nvidia/deepstream/deepstream-6.1/Downloads -v /home/beomgon/project/container/images:$deephome/jpegs beomgon/deepstream:postprocess bash
